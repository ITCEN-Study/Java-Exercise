...
public class AFTest {
	public static void main(String[] args) {
		...
		friends[0] = new AcademyFriend("이재혁", "검은색", "헬스", "김치볶음밥");
		friends[1] = new AcademyFriend("정가영", "자주색", "수영", "초밥");
		friends[2] = new AcademyFriend("김윤우", "흰색", "요가", "마라탕");
		friends[3] = new AcademyFriend("안주현", "회색", "산책", "햄버거");
		friends[4] = new AcademyFriend("조윤지", "하늘색", "독서", "피자");
		
		for (AcademyFriend f : friends) {
			System.out.print(f.getName() + " 동료는 좋아하는 칼라가 " + f.getColor() + " 입니다." + " 그리고  제일 좋아하는 음식은 " + f.getFood());
			System.out.println();
			System.out.print("입니다. 지금은 " + AcademyFriend.academyName + " 에서  Java 기반 풀스택과 Python 기반 AI를 학습하고 있어요.");
			System.out.println();
		}
	}
